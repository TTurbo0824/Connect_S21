...
app.get('/search', function(req, res) {
  ...
  var moodquery = new RegExp(req.query.m, 'i');
  db.find({maincontent: query, mood: moodquery}, function(err, docs) {
    var dataWrapper = {data: docs, search: req.query.q || req.query.m};
    res.render("outputtemplate.ejs", dataWrapper);
  })
});
